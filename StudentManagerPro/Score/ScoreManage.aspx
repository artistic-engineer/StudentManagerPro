...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="QueryDiv">
     ...
     <div id="ScoreListDiv">
         ...
         <asp:GridView ID="GridView1" class="ScoreTable" runat="server" AutoGenerateColumns="False">
             <Columns>
                 <asp:BoundField DataField="StudentName" HeaderText="Student Name" />
                 <asp:BoundField DataField="Gender" HeaderText="Gender" />
                 <asp:BoundField DataField="ClassName" HeaderText="Class Name" />
                 <asp:BoundField DataField="CSharp" HeaderText="C# Grade" />
                 <asp:BoundField DataField="SQLServerDB" HeaderText="SQLServer Grade" />
                 <asp:HyperLinkField DataNavigateUrlFields="StudentId" DataNavigateUrlFormatString="~/Student/StudentDetail.aspx?StudentId={0}" HeaderText="Student Information" Text="Details Information" />
             </Columns>
         </asp:GridView>
