...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="StuInfoTable">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlClass" Width="200px" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtStuIdNo" runat="server" Width="150px" CssClass="StuInfoTable"></asp:TextBox>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                 ...
                 <asp:LinkButton ID="lbtnFresh" runat="server">Refrech Validate Code</asp:LinkButton>
