...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="QueryDiv">
     ...
     <div id="ScoreListDiv">
         <asp:GridView ID="gvScoreList" class="ScoreTable" runat="server" 
             AutoGenerateColumns="False" onrowdatabound="gvScoreList_RowDataBound">
             <Columns>
                 ...
                 <asp:HyperLinkField DataNavigateUrlFields="StudentId" 
                     ...
                     HeaderText="学员信息" Target="_blank" Text="详细信息" />
             </Columns>
         </asp:GridView>
	...
	<%--<table class="ScoreTable" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_gvScoreList" style="border-collapse:collapse;">
		...
		</tr><tr onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor=&#39;#6699ff&#39;" onmouseout="this.style.backgroundColor=currentcolor">
