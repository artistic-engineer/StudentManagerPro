...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- <asp:DataList ID="dlStuInfo" runat="server" RepeatColumns="2">
        <ItemTemplate>
            <div class="stuInfo">
                <div class="stuImg">
                    <asp:Image ID="imgStu" runat="server" Height="136px" Width="150px" ImageUrl='<%#Eval("StudentId","~/Images/Student/{0}.png") %>' />
                </div>
                <div class="stuItem">
                ...
                <div class="stuItem">
                    <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#Eval("StudentId","~/Student/EditStudent.apx?StudentId={0}") %>'
    ...
    <asp:Repeater runat="server" ID="rptStuList">
        <ItemTemplate>
         <div class="stuInfo">
                <div class="stuImg">
                    <asp:Image ID="imgStu" runat="server" Height="136px" Width="150px" ImageUrl='<%#Eval("StudentId","~/Images/Student/{0}.png") %>' />
                ...
                <div class="stuItem">
                    <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#Eval("StudentId","~/Student/EditStudent.aspx?StudentId={0}") %>'
                        runat="server" ForeColor="Blue">修改信息</asp:HyperLink>
                    <asp:LinkButton ID="btnDel" OnClientClick="return confirm('确认删除吗？')" OnClick="btnDel_Click" 
                        CommandArgument='<%#Eval("StudentId") %>' runat="server">删除学员</asp:LinkButton>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
